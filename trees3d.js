...
const FORMS = {
  ...
  spruce: P({ type: 'evergreen', levels: 2, angle: [0, 112, 55], children: [115, 4], length: [65, 32, 9], radius: [1.27, .37, .5], sections: [16, 10, 4], segments: [8, 5, 3], start: [0, .06, .15], taper: [.7, .7, .7], twist: [0, 0, 0], gnarl: [.04, .08, .08], force: .006, leaves: { angle: 25, count: 11, start: .05, size: 3.3, var: .25 }, trunkR: .015 }),
  fir: P({ type: 'evergreen', levels: 2, angle: [0, 95, 50], children: [100, 4], length: [60, 27, 8], radius: [1.2, .36, .5], sections: [16, 10, 4], segments: [8, 5, 3], start: [0, .06, .15], taper: [.7, .7, .7], twist: [0, 0, 0], gnarl: [.03, .06, .08], force: .004, leaves: { angle: 30, count: 11, start: .05, size: 3.1, var: .25 }, trunkR: .016 }),
  ...
  cedar: P({ type: 'evergreen', levels: 2, angle: [0, 88, 70], children: [34, 9], length: [55, 44, 13], radius: [1.8, .45, .6], sections: [16, 8, 5], segments: [10, 5, 3], start: [0, .12, .05], taper: [.7, .7, .7], twist: [0, .15, 0], gnarl: [.04, .06, .08], force: .003, leaves: { angle: 75, count: 17, start: .02, size: 4.2, var: .3 }, trunkR: .028 }),
};
