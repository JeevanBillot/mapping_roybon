...
**Balade 3D** (`3d.html`) : relief LiDAR, photo aérienne haute définition au sol et sur les toits, paysage environnant, bâtiments BD TOPO avec toits reconstruits d'après la surface LiDAR (pentes, faîtages, croupes, végétation écartée ; à défaut, toit à deux pentes d'après les altitudes de toit BD TOPO) et murs montant jusqu'au toit, arbres modélisés par espèce à leur hauteur et largeur mesurées, autres arbres détectés, vent, ciel, étiquettes. Modes survol et balade à hauteur d'homme.
